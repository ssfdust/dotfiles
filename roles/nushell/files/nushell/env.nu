...
use ~/.config/nushell/archlinux.nu *
use ~/.config/nushell/systemd.nu *
use ~/.config/nushell/common-aliases.nu *
use ~/.config/nushell/arch_update.nu *
